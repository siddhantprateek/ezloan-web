  ...
  return (
    <Layout>
      ...
      <div className="min-h-screen mb-6 flex flex-col items-start">
        ...
        >
          <p>
            <strong>Phone:</strong> +91 7060186065
          </p>
          <p>
            <strong>Email: </strong>suraj171987singh@gmail.com
          </p>
          <p>
            <strong>Get your Queries resolved: </strong><a className="text-indigo-700" href="https://forms.gle/32LFRE14fUtAz1hZ9">Click to on Me.</a>
          </p>
        </div>
